...
window.onload = function () {
  ...
  tiempo_ticks = document.getElementById("minutos-tic");

  btn_parar.onclick = function () {
    btn_parar.style.display = "none";
    btn_avanzar.style.display = "block";
  ...
  btn_avanzar.onclick = async function () {
    ...
    if (document.getElementById("volumen").value.length == 0 
        || document.getElementById("temp-medio").value.length == 0 
        || document.getElementById("minutos-tic").value.length == 0) 
        {
          alert("Faltan llenar algunos campos")
         } 
    else
    {
      // Ocultar-mostrar botones de ejecutar y paro
      btn_avanzar.style.display = "none";
      ...
      while (window.repetir == true) {
        ...
        var datos = {
          ...
          tiempo_ticks : window.tiempo_ticks
